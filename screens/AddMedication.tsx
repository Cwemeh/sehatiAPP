...
import { ChevronLeft, Plus, X, Calendar, Repeat, Save } from 'lucide-react';
...
export const AddMedication: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Start date set to midnight of today for clean interval calculation
  ...
  return (
    <div className="p-6 space-y-6 pb-12">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Tambah Obat</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="space-y-6">
              ...
              {frequencyType === 'interval' && (
                <div className="flex items-center gap-4 animate-in slide-in-from-top-2 duration-300">
                  ...
                  <div className="bg-amber-50 dark:bg-amber-500/10 p-3 rounded-2xl border border-amber-100 dark:border-amber-500/20">
                    <p className="text-[10px] text-amber-700 dark:text-amber-400 font-bold leading-tight">Mulai dihitung dari hari ini.</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Jumlah Stok</label>
                  <input 
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm">
              <label className="block text-[10px] font-black text-slate-400 uppercase mb-3 ml-1">Warna Identifikasi</label>
        ...
        <div className="pt-4 pb-12">
          <button type="submit" className="w-full py-5 bg-rose-500 text-white rounded-[32px] font-black text-lg shadow-2xl shadow-rose-200 dark:shadow-none transition-all active:scale-95 flex items-center justify-center gap-3">
            <Save size={24} /> SIMPAN JADWAL
          </button>
        </div>
      </form>
    </div>
